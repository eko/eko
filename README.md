...
- [etf1/kafka-mongo-watcher](https://github.com/etf1/kafka-mongo-watcher) ([v0.3.4](https://github.com/etf1/kafka-mongo-watcher/releases/tag/v0.3.4), today) - A MongoDB collection watcher that pushes oplog events into Kafka
- [eko/pihole-exporter](https://github.com/eko/pihole-exporter) ([v0.3.0](https://github.com/eko/pihole-exporter/releases/tag/v0.3.0), 5 days ago) - A Prometheus exporter for PI-Hole&#39;s Raspberry PI ad blocker
