...
- [OpenTelemetry: Trace and instrument your application code](https://vincent.composieux.fr/article/opentelemetry-trace-and-instrument-your-application-code) (1 week ago)
...
- [etf1/kafka-mongo-watcher](https://github.com/etf1/kafka-mongo-watcher) ([v0.2.2](https://github.com/etf1/kafka-mongo-watcher/releases/tag/v0.2.2), 6 days ago) - A MongoDB collection watcher that pushes oplog events into Kafka
- [etf1/opentelemetry-go-contrib](https://github.com/etf1/opentelemetry-go-contrib) ([instrumentation/github.com/confluentinc/confluent-kafka-go/otelconfluent/v1.0.0](https://github.com/etf1/opentelemetry-go-contrib/releases/tag/instrumentation%2Fgithub.com%2Fconfluentinc%2Fconfluent-kafka-go%2Fotelconfluent%2Fv1.0.0), 4 weeks ago) - Instrumentations of third-party libraries using opentelemetry-go library
