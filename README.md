...
- [etf1/kafka-transformer](https://github.com/etf1/kafka-transformer) ([v0.0.7](https://github.com/etf1/kafka-transformer/releases/tag/v0.0.7), 3 weeks ago) - kafka-transformer is a library for simplyfing message transformation tasks when using kafka
...
- [eko/FeedBundle](https://github.com/eko/FeedBundle) ([2.2.0](https://github.com/eko/FeedBundle/releases/tag/2.2.0), 7 months ago) - A Symfony bundle to build RSS feeds from your entities
