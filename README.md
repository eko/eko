...
- [Authz: Authorization backend using ABAC and RBAC](https://vincent.composieux.fr/article/authz-authorisation-backend-using-rbac-and-abac) (4 weeks ago)
...
- [eko/authz](https://github.com/eko/authz) ([v0.8.0](https://github.com/eko/authz/releases/tag/v0.8.0), 2 days ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
- [gofiber/contrib](https://github.com/gofiber/contrib) ([v1.0.1](https://github.com/gofiber/contrib/releases/tag/v1.0.1), 6 days ago) - 🧬 Repository for third party middlewares with dependencies
