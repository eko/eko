...
- [etf1/kafka-mongo-watcher](https://github.com/etf1/kafka-mongo-watcher) ([v0.3.3](https://github.com/etf1/kafka-mongo-watcher/releases/tag/v0.3.3), today) - A MongoDB collection watcher that pushes oplog events into Kafka
