...
- [eko/authz](https://github.com/eko/authz) ([v0.8.4](https://github.com/eko/authz/releases/tag/v0.8.4), 2 days ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
- [gofiber/contrib](https://github.com/gofiber/contrib) ([fiberzerolog/v0.1.4](https://github.com/gofiber/contrib/releases/tag/fiberzerolog/v0.1.4), 4 days ago) - 🧬 Repository for third party middlewares with dependencies
