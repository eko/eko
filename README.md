...
- [eko/authz](https://github.com/eko/authz) ([v0.9.1](https://github.com/eko/authz/releases/tag/v0.9.1), 4 months ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
