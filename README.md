...
- [Dependency injection in Go with uber-go/fx](https://vincent.composieux.fr/article/dependency-injection-in-go-with-uber-go-fx) (2 weeks ago)
...
- [eko/pihole-exporter](https://github.com/eko/pihole-exporter) ([v0.3.0](https://github.com/eko/pihole-exporter/releases/tag/v0.3.0), 3 weeks ago) - A Prometheus exporter for PI-Hole&#39;s Raspberry PI ad blocker
