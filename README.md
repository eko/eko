...
- [eko/authz](https://github.com/eko/authz) ([v0.2.1](https://github.com/eko/authz/releases/tag/v0.2.1), today) - 🛡️ An authorization management backend that comes with its UI for managing both RBAC and ABAC
