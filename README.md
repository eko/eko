...
- [eko/authz](https://github.com/eko/authz) ([v0.8.3](https://github.com/eko/authz/releases/tag/v0.8.3), 2 days ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
