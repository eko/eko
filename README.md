...
- [etf1/kafka-mongo-watcher](https://github.com/etf1/kafka-mongo-watcher) ([v0.2.0](https://github.com/etf1/kafka-mongo-watcher/releases/tag/v0.2.0), 1 week ago) - A MongoDB collection watcher that pushes oplog events into Kafka
