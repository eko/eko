...
- [graph-gophers/graphql-go](https://github.com/graph-gophers/graphql-go) ([v1.2.0](https://github.com/graph-gophers/graphql-go/releases/tag/v1.2.0), 4 days ago) - GraphQL server with a focus on ease of use
