...
- [eko/authz](https://github.com/eko/authz) ([v0.2.1](https://github.com/eko/authz/releases/tag/v0.2.1), 2 days ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
