...
- [etf1/kafka-mongo-watcher](https://github.com/etf1/kafka-mongo-watcher) ([v0.2.1](https://github.com/etf1/kafka-mongo-watcher/releases/tag/v0.2.1), 4 days ago) - A MongoDB collection watcher that pushes oplog events into Kafka
