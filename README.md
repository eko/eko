...
- [gofiber/contrib](https://github.com/gofiber/contrib) ([paseto/v1.0.5](https://github.com/gofiber/contrib/releases/tag/paseto/v1.0.5), today) - 🧬 Repository for third party middlewares with dependencies
