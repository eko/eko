...
- [gofiber/contrib](https://github.com/gofiber/contrib) ([casbin/v1.0.9](https://github.com/gofiber/contrib/releases/tag/casbin/v1.0.9), today) - 🧬 Repository for third party middlewares with dependencies
