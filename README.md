...
- [graph-gophers/graphql-go](https://github.com/graph-gophers/graphql-go) ([v1.1.0](https://github.com/graph-gophers/graphql-go/releases/tag/v1.1.0), 4 months ago) - GraphQL server with a focus on ease of use
