...
- [Dependency injection in Go with uber-go/fx](https://vincent.composieux.fr/article/dependency-injection-in-go-with-uber-go-fx) (5 days ago)
...
- [eko/pihole-exporter](https://github.com/eko/pihole-exporter) ([v0.3.0](https://github.com/eko/pihole-exporter/releases/tag/v0.3.0), 1 week ago) - A Prometheus exporter for PI-Hole&#39;s Raspberry PI ad blocker
