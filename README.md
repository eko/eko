...
- [etf1/kafka-transformer](https://github.com/etf1/kafka-transformer) ([v0.0.7](https://github.com/etf1/kafka-transformer/releases/tag/v0.0.7), 4 days ago) - kafka-transformer is a library for simplyfing message transformation tasks when using kafka
