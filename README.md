...
- [eko/authz](https://github.com/eko/authz) ([v0.0.1](https://github.com/eko/authz/releases/tag/v0.0.1), 1 day ago) - 🛡️ An authorization management backend that comes with its UI for managing both RBAC and ABAC
