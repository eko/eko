...
- [Authz: Authorization backend using ABAC and RBAC](https://vincent.composieux.fr/article/authz-authorisation-backend-using-rbac-and-abac) (4 days ago)
...
- [eko/authz](https://github.com/eko/authz) ([v0.5.0](https://github.com/eko/authz/releases/tag/v0.5.0), 1 day ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
