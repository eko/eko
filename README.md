...
- [eko/authz](https://github.com/eko/authz) ([v0.7.0](https://github.com/eko/authz/releases/tag/v0.7.0), 1 day ago) - 🛡️ Authorization backend that comes with a UI for RBAC and ABAC permissions
